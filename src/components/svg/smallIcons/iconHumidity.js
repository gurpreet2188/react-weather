...
export function IconHumidity({ s }) {
    ...
    return (
        <svg width={s} height={s} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clipPath="url(#clip0_33_169)">
                ...
                <circle cx="9" cy="12" r="1" fill={textColor} />
                <circle cx="15" cy="18" r="1" fill={textColor} />
                <line x1="15.4666" y1="11.6727" x2="8.7399" y2="19.0721" stroke={textColor} strokeWidth="1.3" />
            </g>
        </svg>
