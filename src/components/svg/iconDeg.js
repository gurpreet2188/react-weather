...
//    console.log(deg)
    return (
        <svg  width={w} height={h} fill={textColor}  style={{transformOrigin: 'center', transform: `rotate(${0}deg)`, justifySelf: 'center', alignSelf:'center'}} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
