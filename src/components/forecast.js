      ...
      <div className='forecast-header'>
        <div className='forecast-header-switch' style={{ color: textColor }}>
          ...
          <button className='forecast-header-switch-types'>
            ...
            <button
              onClick={graphHumidity}
              style={{ ...btnStyles('humidity') }}
            >
            ...
            <button
              onClick={graphRain}
              style={{ ...btnStyles('rain'), display: showRain ? '' : 'none' }}
            >
              <IconWeatherAll
                size={iconSize}
                clouds={0}
            ...
            <button
              onClick={graphSnow}
              style={{ ...btnStyles('snow'), display: showSnow ? '' : 'none' }}
            >
              <IconWeatherAll
                size={iconSize}
                clouds={0}
